...
export class LedgerService {
  static async createTransactionWithEntries(
    ...
    try {
      ...
      console.error("Error in createTransactionWithEntries:", error);
      throw new InternalServerError("Failed to create transaction with entries");
    }
  }
  ...
  static async getAccountBalances(businessId: string, asOfDate: Date) {
    try {
      ...
      throw new InternalServerError("Failed to retrieve account balances");
    }
  }
}
