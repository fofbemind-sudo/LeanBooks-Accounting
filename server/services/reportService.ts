...
export class ReportService {
  static async getProfitAndLoss(businessId: string, startDate: Date, endDate: Date) {
    try {
      ...
      throw new InternalServerError("Failed to generate Profit & Loss report");
    }
  }
  ...
  static async getBalanceSheet(businessId: string, asOfDate: Date) {
    try {
      ...
      throw new InternalServerError("Failed to generate Balance Sheet report");
    }
  }
  ...
  static async getCashBalance(businessId: string, asOfDate: Date) {
    try {
      ...
      throw new InternalServerError("Failed to retrieve cash balance");
    }
  }
  ...
  static async getCashFlow(businessId: string, startDate: Date, endDate: Date) {
    try {
      ...
      throw new InternalServerError("Failed to generate Cash Flow report");
    }
  }
}
